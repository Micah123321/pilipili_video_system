!function (e, t) {
    ...
    return function (e) {
        ...
        var a = n(16), o = i(a), s = n(17), r = i(s), l = n(18), c = i(l), u = n(19), d = i(u), p = n(20), h = i(p),
            ...
            T = n(26), L = i(T), M = n(27), _ = i(M), q = n(28), E = i(q), B = n(29), P = i(B), C = n(30), O = i(C),
            z = n(31), F = i(z), I = {
                play: o.default,
                pause: r.default,
                volumeUp: c.default,
...
\`---'.|   |  ,   /  ---\`-'  |  ,   / \`---'.|   |  ,   /  ---\`-'  |  ,   /  
  \`---\`    ---\`-'            ---\`-'    \`---\`    ---\`-'            ---\`-'   
                                                                          `)
        console.log('%cwww.pilipili.cn', 'font-size:2em');
        ...
        var o = function () {
            ...
            M = n(39), _ = i(M), q = n(40), E = i(q), B = n(41), P = i(B), C = n(42), O = i(C), z = n(43), F = i(z),
            I = n(45), j = i(I), D = n(46), W = i(D), H = n(47), A = i(H), V = n(48), R = i(V), X = n(49), N = i(X),
            U = n(4), $ = i(U), Q = 0, J = [], Y = function () {
                ...
                return o(e, [{
                    ...
                    key: "play", value: function () {
                        ...
                        }), this.time.enable("loading"), this.time.enable("progress"), this.container.classList.remove("yzmplayer-paused"), this.container.classList.add("yzmplayer-playing"), this.danmaku && this.danmaku.play(), this.options.mutex) for (var t = 0; t < J.length; t++) this !== J[t] && J[t].pause()
                    }
                }, {
        ...
        t.default = function (e) {
            ...
            }, {text: "micah", link: "http://pilipili.cn"}]), e
        }
    }, function (e, t, n) {
        "use strict";
        Object.defineProperty(t, "__esModule", {value: !0});
            ...
            return o(e, [{
                ...
                key: "_readAllEndpoints", value: function (e, t) {
                    for (var n = this, i = [], a = 0, o = 0; o < e.length; ++o) this.options.apiBackend.read(e[o], function (o) {
                        return function (s, r) {
                            if (++a, s) s.response ? n.options.error(s.response.msg) : n.options.error("弹幕加载失败：" + s.status), i[o] = []; else {
                ...
                key: "draw", value: function (e) {
                    ...
                    if (this.showing) {
                        ...
                        for (var u = document.createDocumentFragment(), d = 0; d < e.length; d++) !function (a) {
                            ...
                            o.classList.add("yzmplayer-danmaku-item"), o.classList.add("yzmplayer-danmaku-" + e[a].type), e[a].border ? o.innerHTML = '<span style="border-bottom:' + e[a].border + '">' + e[a].text + "</span>" : o.innerHTML = e[a].text, o.style.opacity = t._opacity, o.style.color = e[a].color, o.addEventListener("animationend", function () {
            ...
            return o(e, [{
                ...
                key: "initVolumeButton", value: function () {
                    var e = this, t = function (t) {
                        ...
                        document.removeEventListener(r.default.nameMap.dragEnd, n), document.removeEventListener(r.default.nameMap.dragMove, t), e.player.template.volumeButton.classList.remove("yzmplayer-volume-active")
                    };
                    this.player.template.volumeBarWrapWrap.addEventListener("click", function (t) {
                        ...
                        document.addEventListener(r.default.nameMap.dragMove, t), document.addEventListener(r.default.nameMap.dragEnd, n), e.player.template.volumeButton.classList.add("yzmplayer-volume-active")
            ...
            function e(t) {
                ...
                if (this.player.danmaku) {
                    ...
                    var o = function (e) {
                        ...
                        document.removeEventListener(s.default.nameMap.dragEnd, e), document.removeEventListener(s.default.nameMap.dragMove, o), n.player.template.danmakuOpacityBox.classList.remove("yzmplayer-setting-danmaku-active")
                    };
                    this.player.template.danmakuOpacityBarWrapWrap.addEventListener("click", function (e) {
                        ...
                        document.addEventListener(s.default.nameMap.dragMove, o), document.addEventListener(s.default.nameMap.dragEnd, r), n.player.template.danmakuOpacityBox.classList.add("yzmplayer-setting-danmaku-active")
                    })
                }
            }
