$(function () {
    ...
    delVideo= (pid)=> {
        $.ajax({
            ...
            error: function (data) {
                piliModel("错误信息", "删除失败，请之后再试", "article-v2-wrap", function (e){console.log(e)}, data)
            }
        })
    }
