...
insert  into `p_collect`(`id`,`user_id`,`title`,`createTime`,`intro`) values (1,1,'第一个收藏夹','2021-04-09 10:32:19','第一个收藏夹'),(2,1,'默认收藏夹','2021-04-20 12:40:47','默认收藏夹'),(7,1,'GG','2021-04-24 09:59:04',NULL),(8,1,'KK','2021-04-24 10:16:21',NULL),(9,1,'HH','2021-04-24 10:17:09',NULL),(10,1,'AA','2021-04-24 10:19:05',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='收藏夹信息表';

/*Data for the table `p_collect_info` */

insert  into `p_collect_info`(`id`,`collect_id`,`video_id`,`addTime`) values (2,1,10000,'2021-04-09 10:34:17'),(3,1,10001,'2021-04-09 11:02:46'),(4,2,10002,'2021-04-20 12:43:49'),(5,2,10007,'2021-04-20 12:44:21'),(6,2,10008,'2021-04-22 08:41:30'),(7,2,10009,'2021-04-23 10:22:39');
...
insert  into `p_subscribe`(`id`,`subscribe_id`,`subscribed_id`,`createTime`) values (1,2,1,'2021-04-09 10:40:02'),(3,4,1,'2021-04-06 14:27:17'),(4,1,2,'2021-04-25 15:00:35'),(7,3,1,'2021-04-26 11:04:50');
...
insert  into `p_user_info`(`id`,`user_id`,`subscribeNum`,`fansNum`,`level`,`experience`,`user_pic`,`up_desc`,`nickName`,`up_spaceNotice`,`createTime`,`birthday`) values (1,1,1,3,6,1,'/uploads/877514110aa3427f943ddc7dd55ef48aa7bf8942.jpg@96w_96h_1c.webp','这是本站第一个用户','Micah','这是本站第一个用户','2021-04-20 10:44:49','2021-04-20 10:44:52'),(2,2,1,1,1,0,'/uploads/defaultpic.png','你好，我是张三','张三',NULL,NULL,NULL),(3,3,1,0,1,0,'/uploads/defaultpic.png','你好，我是李四','李四',NULL,NULL,NULL),(4,4,1,0,1,0,'/uploads/defaultpic.png','这个人没有填简介啊~~~','王五',NULL,NULL,NULL);
