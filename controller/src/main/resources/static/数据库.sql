...
CREATE TABLE `p_appeals` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='申诉表';

/*Data for the table `p_appeals` */

insert  into `p_appeals`(`id`,`user_id`,`video_id`,`createTime`,`content`,`phone`,`email`,`source_material`,`check_uid`,`state`,`editTime`) values (14,1,10141,'2021-05-24 11:58:34','aaa','ccc','  cc',NULL,0,0,NULL);
